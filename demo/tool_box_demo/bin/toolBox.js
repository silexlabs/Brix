...
$hxExpose(slplayer.core.Application, "toolBox");
...
slplayer.core.Application.init = function(appendTo,args) {
	haxe.Log.trace("SLPlayer init() called with appendTo=" + Std.string(appendTo) + " and args=" + Std.string(args),{ fileName : "Application.hx", lineNumber : 188, className : "slplayer.core.Application", methodName : "init"});
...
slplayer.core.Application.prototype = {
	...
	,launch: function(appendTo) {
		haxe.Log.trace("Launching SLPlayer id " + this.id + " on " + Std.string(appendTo),{ fileName : "Application.hx", lineNumber : 112, className : "slplayer.core.Application", methodName : "launch"});
		if(appendTo != null) {
			haxe.Log.trace("setting htmlRootElement to " + Std.string(appendTo),{ fileName : "Application.hx", lineNumber : 118, className : "slplayer.core.Application", methodName : "launch"});
...
slplayer.ui.interaction.Draggable.prototype = $extend(slplayer.ui.DisplayObject.prototype,{
	...
	,move: function(e) {
		haxe.Log.trace("Draggable move " + Std.string(this.state),{ fileName : "Draggable.hx", lineNumber : 233, className : "slplayer.ui.interaction.Draggable", methodName : "move"});
	...
	,stopDrag: function(e) {
		haxe.Log.trace("Draggable stopDrag droped! " + Std.string(this.state),{ fileName : "Draggable.hx", lineNumber : 206, className : "slplayer.ui.interaction.Draggable", methodName : "stopDrag"});
		if(this.state == slplayer.ui.interaction.DraggableState.dragging) {
			haxe.Log.trace("Draggable stopDrag droped! " + Std.string(this.bestDropZone),{ fileName : "Draggable.hx", lineNumber : 208, className : "slplayer.ui.interaction.Draggable", methodName : "stopDrag"});
			if(this.bestDropZone != null) {
				...
				haxe.Log.trace("Draggable stopDrag droped! " + Std.string(this.state),{ fileName : "Draggable.hx", lineNumber : 213, className : "slplayer.ui.interaction.Draggable", methodName : "stopDrag"});
	...
	,startDrag: function(e) {
		var _g = this;
		haxe.Log.trace("Draggable startDrag " + Std.string(this.state),{ fileName : "Draggable.hx", lineNumber : 184, className : "slplayer.ui.interaction.Draggable", methodName : "startDrag"});
		if(this.state == slplayer.ui.interaction.DraggableState.none) {
			...
			js.Lib.document.body.onmousemove = function(e1) {
				_g.move(e1);
			};
		}
	}
	...
	,initPhantomStyle: function() {
		...
		haxe.Log.trace("initPhantomStyle " + Std.string(computedStyle),{ fileName : "Draggable.hx", lineNumber : 152, className : "slplayer.ui.interaction.Draggable", methodName : "initPhantomStyle"});
	...
	,init: function() {
		...
		haxe.Log.trace("Draggable init",{ fileName : "Draggable.hx", lineNumber : 107, className : "slplayer.ui.interaction.Draggable", methodName : "init"});
		...
		js.Lib.document.onmouseup = $bind(this,this.stopDrag);
...
slplayer.ui.list.List.prototype = $extend(slplayer.ui.DisplayObject.prototype,{
	...
	,setSelectedItem: function(selected) {
		haxe.Log.trace("setSelectedItem " + Std.string(selected) + " - " + Type.getClassName(Type.getClass(this)),{ fileName : "List.hx", lineNumber : 189, className : "slplayer.ui.list.List", methodName : "setSelectedItem"});
	...
	,updateSelectionDisplay: function(selection) {
		haxe.Log.trace("updateSelectionDisplay " + Std.string(selection) + " - " + Type.getClassName(Type.getClass(this)),{ fileName : "List.hx", lineNumber : 132, className : "slplayer.ui.list.List", methodName : "updateSelectionDisplay"});
		...
		while(_g1 < _g) {
			...
			if(idxElem >= 0) {
				...
				if(children[idx] == null) {
					haxe.Log.trace("--workaround--" + idx + "- " + Std.string(children[idx]),{ fileName : "List.hx", lineNumber : 148, className : "slplayer.ui.list.List", methodName : "updateSelectionDisplay"});
					continue;
				}
				var className = "";
...
slplayer.util.DomTools.inspectTrace = function(obj) {
	...
	while(_g < _g1.length) {
		var prop = _g1[_g];
		++_g;
		haxe.Log.trace("- " + prop + " = " + Std.string(Reflect.field(obj,prop)),{ fileName : "DomTools.hx", lineNumber : 77, className : "slplayer.util.DomTools", methodName : "inspectTrace"});
	}
}
...
slplayer.ui.interaction.Draggable.EVENT_OVER = "dragEventOver";
slplayer.ui.interaction.Draggable.EVENT_OUT = "dragEventOut";
