...
Then, simply configure an alias in your Apache conf like this one :
	...
	Alias /brix/ "E:/PATH_TO_MY_FILES/brix_repository/" 

	<Directory "E:/PATH_TO_MY_FILES/brix_repository/">
...
Finally open a browser on http://127.0.0.1/brix/demo/discover_brix/Brix.html to see the HTML/js output
	
And http://127.0.0.1/brix/demo/discover_brix/index_as3.html for the AS3 output