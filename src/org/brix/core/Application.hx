...
class Application 
{
	 ...
	 */
	private var nodeToCmpInstances : Hash<List<org.brix.component.ui.DisplayObject>>;
	/**
	 ...
	 * A UI component class is a child class of org.brix.component.ui.DisplayObject
	 */
	 ...
	 * Ideally, a component class should at least implement org.brix.component.IBrixComponent.
	 */
	...
	{
		var comps:List<org.brix.component.ui.DisplayObject> = createUIComponents(node);
	 ...
	 */
	private function createUIComponents(node:HtmlDom):Null<List<org.brix.component.ui.DisplayObject>>
	{
		if ( node.nodeType != 1 )
		{
		...
		var compsToInit:List<org.brix.component.ui.DisplayObject> = new List();
	 ...
	 */
	private function initUIComponents(compInstances:List<org.brix.component.ui.DisplayObject>):Void
	{
	...
	private function createNonUIComponents():Void
	{
		for (rc in registeredNonUIComponents)
		{
			...
			if (cmpInstance != null && Std.is(cmpInstance, org.brix.component.IBrixComponent))
			{
	...
	public function cleanNode(node:HtmlDom):Void
	{
		...
		var comps:List<org.brix.component.ui.DisplayObject> = getAssociatedComponents(node, org.brix.component.ui.DisplayObject);
	 ...
	 */
	public function addAssociatedComponent(node : HtmlDom, cmp : org.brix.component.ui.DisplayObject) : Void
	{
		var nodeId = node.getAttribute(BRIX_ID_ATTR_NAME);
		
		var associatedCmps : List<org.brix.component.ui.DisplayObject>;
	 ...
	 */
	public function removeAssociatedComponent(node : HtmlDom, cmp : org.brix.component.ui.DisplayObject) : Void
	{
		var nodeId = node.getAttribute(BRIX_ID_ATTR_NAME);
	 ...
	 */
	public function getAssociatedComponents<TypeFilter : org.brix.component.ui.DisplayObject>(node : HtmlDom, typeFilter:Class<TypeFilter>) : List<TypeFilter>
	{
		var nodeId = node.getAttribute(BRIX_ID_ATTR_NAME);
