 ...
 */
package org.brix.component.list;

import js.Lib;
import js.Dom;
import org.brix.component.interaction.Draggable;

import org.brix.util.DomTools;

import org.brix.component.ui.DisplayObject;
import org.brix.component.template.TemplateMacros;
...
class List<ElementClass> extends DisplayObject
{
	...
	public function doRedraw()
	{
		...
		for (i in 0...rootElement.childNodes.length)
		{
			getBrix().cleanNode(rootElement.childNodes[i]);
		}
		...
		for (i in 0...rootElement.childNodes.length)
		{
			getBrix().initNode(rootElement.childNodes[i]);
		}
	...
	function setSelectedItem(selected:Null<ElementClass>):Null<ElementClass> 
	{
		...
		//DomTools.inspectTrace(selected, "org.brix.component.list.List"); 
