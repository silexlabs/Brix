 ...
 */
package org.brix.component.ui;

import org.brix.core.Application;

import org.brix.component.IBrixComponent;
using org.brix.component.IBrixComponent.BrixComponent;
...
class DisplayObject implements IDisplayObject
{
	...
	{
		return BrixComponent.getBrix(this);
	}
	...
	private function new(rootElement : HtmlDom, BrixId:String) 
	{
		...
		getBrix().addAssociatedComponent(rootElement, this);
	}
	...
	public function remove():Void
	{
		...
		getBrix().removeAssociatedComponent(rootElement,this);
	}
	...
	{
		if (cmpClass == Type.resolveClass("org.brix.component.ui.DisplayObject"))
			return true;
