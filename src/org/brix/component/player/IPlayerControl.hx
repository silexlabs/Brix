 ...
 */
package org.brix.component.player;
...
/**
 * Any PlayerControl component should implement and be "using org.brix.component.player.PlayerControl" to be compliant with
 * Playable components.
 * 
