...
/**
 * Any PlayerControl component should implement and be "using brix.component.player.PlayerControl" to be compliant with
 * Playable components.
 * 
 ...
 * 
 * This contract is for the moment a draft as no Player components has been released yet in the Brix distribution.
